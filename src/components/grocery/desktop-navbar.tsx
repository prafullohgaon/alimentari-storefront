  ...
  return (
    <header className="hidden md:block sticky top-0 relative z-40 select-none w-full bg-white">
      ...
      >
        ...
        <div
          className={cn(
            "bg-slate-50 border-b border-slate-200 text-xs text-slate-500 font-semibold flex items-center h-10 overflow-hidden transition-opacity duration-300 ease-in-out",
        ...
        {/* Main Desktop Navbar Row (Fixed layout height to prevent layout shift) */}
        <div
          className={cn(
            "w-full bg-white border-b h-[76px] flex items-center transition-all duration-300",
